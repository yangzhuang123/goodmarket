	...
	<!--  -->
		<div class="breadcrumb-preview">
			<el-breadcrumb :separator="'≡'">
				...
				<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" :to="'/index/chathelper?centerType=' + (centerType?'1':'0')"><a>{{item.name}}</a></el-breadcrumb-item>
